...
import 'package:advanced_weather_app/entities/response.dart';
import 'package:advanced_weather_app/entities/weather.dart';
import 'package:advanced_weather_app/services/geocoding.service.dart';
import 'package:advanced_weather_app/services/location.service.dart';
import 'package:advanced_weather_app/services/weather.service.dart';
  ...
  */
  ...
  Future<List<Geocoding>> getGeocodings(String cityName) async {
    try {
      ...
      return geocodings.sublist(0, min(geocodings.length, 5));
    } catch (e) {
      error = ErrorStatus.connectionFailed;
      return List.empty();
    } finally {
